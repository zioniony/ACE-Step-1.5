...
**顶部：模式选择**
- 支持多种生成模式：`Simple`、`Custom`、`Remix`、`Repaint`、`Lego`、`Extract`、`Complete`
...
**Cover Strength（覆盖强度）**
- `codes_strength`：控制参考音频/codes 的影响强度（0.0–1.0）
...
**何时关闭：**
- 你已经有明确的规划目标
- 你使用 Cover/Repaint 模式（此时你自己成为规划者）
- 你追求最快的生成速度
...
| 按钮 | 功能 |
|------|------|
| `Send to Cover` | 将此结果作为源音频发送到 Remix 模式 |
